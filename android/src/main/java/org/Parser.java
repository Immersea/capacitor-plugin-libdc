...
public class Parser extends Handle
{
	...
	public static final int DC_DIVEMODE_OC = 2;  /* Open circuit */
	public static final int DC_DIVEMODE_CCR = 3; /* Closed circuit rebreather */
	public static final int DC_DIVEMODE_SCR = 4; /* Semi-closed circuit rebreather */
	...
	public static final int DC_SENSOR_NONE = 0xFFFFFFFF;
	public static final int DC_GASMIX_UNKNOWN = 0xFFFFFFFF;
