...
Pod::Spec.new do |s|
  ...
  # Include libdivecomputer Swift wrapper
  s.source_files = 'ios/Plugin/**/*.{swift,h,m,c,cc,mm,cpp}', 
  ...
  s.pod_target_xcconfig = {
    'HEADER_SEARCH_PATHS' => '"$(PODS_TARGET_SRCROOT)/ios/Plugin/Sources/Clibdivecomputer/include" "$(PODS_TARGET_SRCROOT)/ios/Plugin/Sources/LibDCBridge/include"',
